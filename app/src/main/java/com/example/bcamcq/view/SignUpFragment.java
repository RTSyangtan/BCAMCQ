...
public class SignUpFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editEmail = view.findViewById(R.id.usernameRegId);
        editPass = view.findViewById(R.id.passwordRegId);
        signInText = view.findViewById(R.id.goLoginId);
        signUpBtn = view.findViewById(R.id.signupButtonId);
