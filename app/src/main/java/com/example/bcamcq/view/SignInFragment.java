...
import com.example.bcamcq.viewmodel.AuthViewModel;
...
public class SignInFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editEmail = view.findViewById(R.id.usernameLoginId);
        editPass = view.findViewById(R.id.passwordLoginId);
        signUpText = view.findViewById(R.id.goSignUpId);
        signInBtn = view.findViewById(R.id.loginButtonId);
